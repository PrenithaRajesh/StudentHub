...
export class TableComponent implements OnInit {
  ...
  columnDefs = [
    {
      ...
      cellRenderer: 'updateDataRenderer',
      width: 60,
    },

    {
      headerName: 'Name',
      field: 'firstName',
      onCellClicked: (params: any) => this.openNameDialog(params),
...

    {
      headerName: 'Address',
      field: 'address',
      onCellClicked: (params: any) => this.openAddDialog(params),
      columnGroupShow: 'open',
    },
      ...
      children: [
        {
          headerName: 'Physics',
          field: 'physics',
          onCellClicked: (params: any) => this.openMarksDialog(params),
          columnGroupShow: 'open',
        },
        {
  ...
  openMarksDialog(params: any) {
    ...
    const marksList = this.rowData.map(
      (student) => student[params.colDef.field as keyof typeof student]
    );
